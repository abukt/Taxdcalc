...
export const metadata = {
  title: 'Tax Guides and Salary Advice | TaxdCalc',
    ...
    <div style={{ background: '#F8F9FA', minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
          ...
          {articles.map(function(article) {
            return (
              <Link key={article.slug} href={'/blog/' + article.slug} style={{ textDecoration: 'none' }}>
                <div style={{ background: 'white', borderRadius: 12, padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.07)', border: '1px solid #E2E8F0', height: '100%', cursor: 'pointer' }}>
      ...
      <div style={{ background: '#0C1E3C', padding: '48px 24px', textAlign: 'center' }}>
        <div style={{ maxWidth: 500, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: 15, marginBottom: 24 }}>Free UK salary calculator, updated for 2026-27.</p>
