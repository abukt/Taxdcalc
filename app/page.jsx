...
function ComplianceAlert({ mtd, gross, mob }) {
  ...
  return (
    <div style={{ background: '#FEF2F2', border: '1.5px solid #FECACA', borderRadius: 12, padding: '14px 15px', position: 'relative', marginBottom: 14 }}>
      ...
      <div style={{ fontSize: 11, color: '#7F1D1D', marginTop: 4 }}>Income > £50k requires quarterly digital filing. <a href="https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax" target="_blank" style={{ fontWeight: 700 }}>Software Guide ↗</a></div>
    </div>
  );
}
