      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: mob ? '16px 16px 56px' : '20px 24px 72px' }}>
        <div style={{ background: C.white, borderRadius: 12, padding: mob ? '14px 0' : '18px 0', border: `1px solid ${C.border}`, boxShadow: C.shadow, marginBottom: 16 }} className="fi">
          <div style={{ padding: mob ? '0 14px 12px' : '0 20px 14px' }}>
            <h2 style={{ fontFamily: 'DM Serif Display', fontSize: 18, color: C.navy, marginBottom: 4 }}>Pay Scale & Take-Home 2026-27</h2>
            <p style={{ fontSize: 12, color: C.slate }}>Take-home after income tax, NI and pension. Figures for England & Wales.</p>
          </div>
          <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, minWidth: 480 }}>
              <thead>
                <tr style={{ background: C.bg }}>
                  {['Grade', 'Gross Salary', 'Annual Take-Home', 'Monthly Net', 'Pension', 'Role'].map(h => (
