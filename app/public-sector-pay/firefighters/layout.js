...
const GRADES=[{grade:'Trainee',gross:24680,penPct:14.5,desc:'Training',th:18426,mo:1536},{grade:'Development',gross:28750,penPct:14.5,desc:'In development',th:20885,mo:1740},{grade:'Competent',gross:37898,penPct:14.5,desc:'Fully operational',th:26410,mo:2201},{grade:'Crew Manager',gross:41846,penPct:14.5,desc:'Supervisory',th:28795,mo:2400},{grade:'Watch Manager B',gross:44017,penPct:14.5,desc:'Watch leadership',th:30106,mo:2509},{grade:'Watch Manager A',gross:46983,penPct:14.5,desc:'Senior watch',th:31897,mo:2658}];
...
export default function Page(){
  ...
  const schemaFAQ={
    ...
    mainEntity:[
      {'@type':'Question',name:'What is the take-home pay?',acceptedAnswer:{'@type':'Answer',text:'A competent firefighter (£37,898) takes home approximately £26,410/year (£2,201/month) after income tax, NI and 14.5% Firefighters Pension Scheme contribution in 2026-27.'}},
      {'@type':'Question',name:'How is the pension contribution calculated?',acceptedAnswer:{'@type':'Answer',text:'Firefighters Pension Scheme 2015 — 14.5% employee contribution (highest in UK public sector). Employer contributes approximately 26.5%.'}},
    ]
  };
  const schemaBreadcrumb={'@context':'https://schema.org','@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'TaxdCalc',item:'https://taxdcal.co.uk'},{'@type':'ListItem',position:2,name:'Public Sector Pay',item:'https://taxdcal.co.uk/public-sector-pay'},{'@type':'ListItem',position:3,name:'Firefighter Pay Guide 2026-27',item:'https://taxdcal.co.uk/public-sector-pay/firefighters'}]};
    ...
    <>
      ...
      <div style={{background:C.tealBg,borderBottom:`1px solid ${C.tealBd}`,padding:mob?'13px 16px':'15px 24px'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          ...
          <p style={{fontSize:mob?13:14,color:'#0f766e',fontWeight:600,lineHeight:1.6}}>A competent firefighter (£37,898) takes home approximately £26,410/year (£2,201/month) after income tax, NI and 14.5% Firefighters Pension Scheme contribution in 2026-27.</p>
        </div>
      </div>
      <div style={{background:`linear-gradient(135deg,${C.navy},${C.navyMid})`,padding:mob?'26px 20px 40px':'34px 24px 48px',position:'relative',overflow:'hidden'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          <div style={{display:'inline-block',background:'rgba(13,148,136,0.15)',border:'1px solid rgba(20,184,166,0.3)',borderRadius:20,padding:'3px 12px',fontSize:11,color:'#14B8A6',marginBottom:10,fontFamily:'JetBrains Mono'}}>England & Wales — NJC Grey Book Scale</div>
          <h1 style={{fontFamily:'DM Serif Display',fontSize:mob?22:36,color:'white',lineHeight:1.15,marginBottom:10}}>Firefighter Pay Guide 2026-27</h1>
      ...
      <div style={{maxWidth:900,margin:'0 auto',padding:mob?'16px 16px 56px':'20px 24px 72px'}}>
        ...
        <div style={{background:C.tealBg,border:`1px solid ${C.tealBd}`,borderRadius:10,padding:'14px 16px',marginBottom:16}}>
          ...
          <p style={{fontSize:13,color:'#0f766e',lineHeight:1.7}}>Firefighters Pension Scheme 2015 — 14.5% employee contribution (highest in UK public sector). Employer contributes approximately 26.5%.</p>
        </div>
