...
const GRADES=[{grade:'Admin Officer (AO)',gross:24547,penPct:4.6,desc:'Entry grade',th:20290,mo:1691},{grade:'Executive Officer (EO)',gross:28230,penPct:5.45,desc:'Professional',th:22614,mo:1885},{grade:'Higher Executive Officer',gross:34080,penPct:5.45,desc:'Management',th:26571,mo:2214},{grade:'Senior Executive Officer',gross:40474,penPct:5.45,desc:'Senior professional',th:30896,mo:2575},{grade:'Grade 7',gross:54667,penPct:5.45,desc:'Middle manager',th:40477,mo:3373},{grade:'Grade 6',gross:68040,penPct:6.35,desc:'Senior manager',th:47428,mo:3952}];
...
export default function Page(){
  ...
  const schemaFAQ={
    ...
    mainEntity:[
      {'@type':'Question',name:'What is the take-home pay?',acceptedAnswer:{'@type':'Answer',text:'A Civil Service Administrative Officer (AO, £24,547) takes home approximately £20,290/year (£1,691/month) after income tax, NI and 4.6% Alpha pension in 2026-27.'}},
      {'@type':'Question',name:'How is the pension contribution calculated?',acceptedAnswer:{'@type':'Answer',text:'Civil Service Alpha Pension — 4.6% to 7.35% depending on salary band. Employer contributes approximately 27.9%. Defined benefit career average scheme.'}},
    ]
  };
    ...
    <>
      ...
      <div style={{background:C.tealBg,borderBottom:`1px solid ${C.tealBd}`,padding:mob?'13px 16px':'15px 24px'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          ...
          <p style={{fontSize:mob?13:14,color:'#0f766e',fontWeight:600,lineHeight:1.6}}>A Civil Service Administrative Officer (AO, £24,547) takes home approximately £20,290/year (£1,691/month) after income tax, NI and 4.6% Alpha pension in 2026-27.</p>
        </div>
      </div>
      <div style={{background:`linear-gradient(135deg,${C.navy},${C.navyMid})`,padding:mob?'26px 20px 40px':'34px 24px 48px',position:'relative',overflow:'hidden'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          <div style={{display:'inline-block',background:'rgba(13,148,136,0.15)',border:'1px solid rgba(20,184,166,0.3)',borderRadius:20,padding:'3px 12px',fontSize:11,color:'#14B8A6',marginBottom:10,fontFamily:'JetBrains Mono'}}>Grade AO to Grade 6 — England & Wales</div>
          <h1 style={{fontFamily:'DM Serif Display',fontSize:mob?22:36,color:'white',lineHeight:1.15,marginBottom:10}}>Civil Service Pay Guide 2026-27</h1>
      ...
      <div style={{maxWidth:900,margin:'0 auto',padding:mob?'16px 16px 56px':'20px 24px 72px'}}>
        ...
        <div style={{background:C.tealBg,border:`1px solid ${C.tealBd}`,borderRadius:10,padding:'14px 16px',marginBottom:16}}>
          ...
          <p style={{fontSize:13,color:'#0f766e',lineHeight:1.7}}>Civil Service Alpha Pension — 4.6% to 7.35% depending on salary band. Employer contributes approximately 27.9%. Defined benefit career average scheme.</p>
        </div>
