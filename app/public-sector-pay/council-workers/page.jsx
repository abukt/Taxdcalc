...
const GRADES=[{grade:'SCP 2',gross:24294,penPct:5.5,desc:'Admin/support',th:19942,mo:1662},{grade:'SCP 6',gross:25584,penPct:5.5,desc:'Junior officer',th:20814,mo:1735},{grade:'SCP 12',gross:27711,penPct:5.5,desc:'Technical',th:22252,mo:1854},{grade:'SCP 18',gross:30296,penPct:5.5,desc:'Senior technical',th:24000,mo:2000},{grade:'SCP 25',gross:34314,penPct:7.5,desc:'Team leader',th:26167,mo:2181},{grade:'SCP 31',gross:40221,penPct:8.5,desc:'Officer',th:29744,mo:2479},{grade:'SCP 38',gross:48474,penPct:9.9,desc:'Senior officer',th:34582,mo:2882},{grade:'SCP 43',gross:54589,penPct:9.9,desc:'Principal',th:38759,mo:3230}];
...
export default function Page(){
  ...
  const schemaFAQ={
    ...
    mainEntity:[
      {'@type':'Question',name:'What is the take-home pay?',acceptedAnswer:{'@type':'Answer',text:'A council worker on NJC SCP 2 (£24,294) takes home approximately £19,900/year (£1,658/month) after income tax, NI and 5.5% LGPS pension in 2026-27.'}},
      {'@type':'Question',name:'How is the pension contribution calculated?',acceptedAnswer:{'@type':'Answer',text:'Local Government Pension Scheme (LGPS) — 5.5% to 12.5% tiered by salary. Employer contributes approximately 19% of payroll. Defined benefit career average scheme.'}},
    ]
  };
  const schemaBreadcrumb={'@context':'https://schema.org','@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'TaxdCalc',item:'https://taxdcal.co.uk'},{'@type':'ListItem',position:2,name:'Public Sector Pay',item:'https://taxdcal.co.uk/public-sector-pay'},{'@type':'ListItem',position:3,name:'Council Workers Pay Guide 2026-27',item:'https://taxdcal.co.uk/public-sector-pay/council-workers'}]};
    ...
    <>
      ...
      <div style={{background:C.tealBg,borderBottom:`1px solid ${C.tealBd}`,padding:mob?'13px 16px':'15px 24px'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          ...
          <p style={{fontSize:mob?13:14,color:'#0f766e',fontWeight:600,lineHeight:1.6}}>A council worker on NJC SCP 2 (£24,294) takes home approximately £19,900/year (£1,658/month) after income tax, NI and 5.5% LGPS pension in 2026-27.</p>
        </div>
      </div>
      <div style={{background:`linear-gradient(135deg,${C.navy},${C.navyMid})`,padding:mob?'26px 20px 40px':'34px 24px 48px',position:'relative',overflow:'hidden'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          <div style={{display:'inline-block',background:'rgba(13,148,136,0.15)',border:'1px solid rgba(20,184,166,0.3)',borderRadius:20,padding:'3px 12px',fontSize:11,color:'#14B8A6',marginBottom:10,fontFamily:'JetBrains Mono'}}>NJC Green Book — England, Wales & Northern Ireland</div>
          <h1 style={{fontFamily:'DM Serif Display',fontSize:mob?22:36,color:'white',lineHeight:1.15,marginBottom:10}}>Council Workers Pay Guide 2026-27</h1>
      ...
      <div style={{maxWidth:900,margin:'0 auto',padding:mob?'16px 16px 56px':'20px 24px 72px'}}>
        ...
        <div style={{background:C.tealBg,border:`1px solid ${C.tealBd}`,borderRadius:10,padding:'14px 16px',marginBottom:16}}>
          ...
          <p style={{fontSize:13,color:'#0f766e',lineHeight:1.7}}>Local Government Pension Scheme (LGPS) — 5.5% to 12.5% tiered by salary. Employer contributes approximately 19% of payroll. Defined benefit career average scheme.</p>
        </div>
