...
const GRADES=[{grade:'Constable P1',gross:29907,penPct:6.5,desc:'Entry/probation',th:23497,mo:1958},{grade:'Constable P3',gross:33888,penPct:6.5,desc:'Year 3',th:26157,mo:2180},{grade:'Constable P5',gross:38748,penPct:6.5,desc:'Top of scale',th:29403,mo:2450},{grade:'Sergeant',gross:47472,penPct:6.5,desc:'Supervisory',th:35231,mo:2936},{grade:'Inspector',gross:57162,penPct:6.5,desc:'Management',th:41482,mo:3457},{grade:'Chief Inspector',gross:60678,penPct:6.5,desc:'Senior',th:43384,mo:3615}];
...
export default function Page(){
  ...
  const schemaFAQ={
    ...
    mainEntity:[
      {'@type':'Question',name:'What is the take-home pay?',acceptedAnswer:{'@type':'Answer',text:'A Police Constable on P1 (£29,907) takes home approximately £23,497/year (£1,958/month) after income tax, NI and 6.5% Police Pension Scheme contribution in 2026-27.'}},
      {'@type':'Question',name:'How is the pension contribution calculated?',acceptedAnswer:{'@type':'Answer',text:'Police Pension Scheme 2015 — 6.5% employee contribution. Employer contributes approximately 31% of salary.'}},
    ]
  };
  const schemaBreadcrumb={'@context':'https://schema.org','@type':'BreadcrumbList',itemListElement:[{'@type':'ListItem',position:1,name:'TaxdCalc',item:'https://taxdcal.co.uk'},{'@type':'ListItem',position:2,name:'Public Sector Pay',item:'https://taxdcal.co.uk/public-sector-pay'},{'@type':'ListItem',position:3,name:'Police Pay Guide 2026-27',item:'https://taxdcal.co.uk/public-sector-pay/police'}]};
    ...
    <>
      ...
      <div style={{background:C.tealBg,borderBottom:`1px solid ${C.tealBd}`,padding:mob?'13px 16px':'15px 24px'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          ...
          <p style={{fontSize:mob?13:14,color:'#0f766e',fontWeight:600,lineHeight:1.6}}>A Police Constable on P1 (£29,907) takes home approximately £23,497/year (£1,958/month) after income tax, NI and 6.5% Police Pension Scheme contribution in 2026-27.</p>
        </div>
      </div>
      <div style={{background:`linear-gradient(135deg,${C.navy},${C.navyMid})`,padding:mob?'26px 20px 40px':'34px 24px 48px',position:'relative',overflow:'hidden'}}>
        <div style={{maxWidth:900,margin:'0 auto'}}>
          <div style={{display:'inline-block',background:'rgba(13,148,136,0.15)',border:'1px solid rgba(20,184,166,0.3)',borderRadius:20,padding:'3px 12px',fontSize:11,color:'#14B8A6',marginBottom:10,fontFamily:'JetBrains Mono'}}>England & Wales — NPCC Pay Scale</div>
          <h1 style={{fontFamily:'DM Serif Display',fontSize:mob?22:36,color:'white',lineHeight:1.15,marginBottom:10}}>Police Pay Guide 2026-27</h1>
      ...
      <div style={{maxWidth:900,margin:'0 auto',padding:mob?'16px 16px 56px':'20px 24px 72px'}}>
        ...
        <div style={{background:C.tealBg,border:`1px solid ${C.tealBd}`,borderRadius:10,padding:'14px 16px',marginBottom:16}}>
          ...
          <p style={{fontSize:13,color:'#0f766e',lineHeight:1.7}}>Police Pension Scheme 2015 — 6.5% employee contribution. Employer contributes approximately 31% of salary.</p>
        </div>
