...
export default function NHSPage() {
  ...
  const schemaFAQ={'@context':'https://schema.org','@type':'FAQPage',mainEntity:[
    {'@type':'Question',name:'What is NHS Band 5 take-home pay in 2026-27?',acceptedAnswer:{'@type':'Answer',text:'NHS Band 5 entry (£29,970 gross) takes home approximately £22,748/year after tax, NI and pension.'}},
    {'@type':'Question',name:'How much is the NHS pension contribution?',acceptedAnswer:{'@type':'Answer',text:'NHS pension contributions range from 5.0% to 14.5% based on your pay tier.'}},
  ]};
