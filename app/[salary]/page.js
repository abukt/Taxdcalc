...
const VALID=[18000,19000,20000,21000,22000,23000,24000,25000,26000,27000,28000,29000,30000,31000,32000,33000,34000,35000,36000,37000,38000,39000,40000,41000,42000,43000,44000,45000,46000,47000,48000,49000,50000,52000,55000,58000,60000,65000,70000,75000,80000,85000,90000,95000,100000,110000,120000,125000,130000,140000,150000];
const SPECIAL={'minimum-wage-take-home':{salary:26418,label:'Minimum Wage (£12.71/hr)'},'nhs-band-5-take-home':{salary:29970,label:'NHS Band 5 Entry'},'nhs-band-6-take-home':{salary:37338,label:'NHS Band 6 Entry'},'nhs-band-7-take-home':{salary:43742,label:'NHS Band 7 Entry'},'teacher-salary-take-home':{salary:32916,label:'NQT Teacher M1'},'graduate-salary-take-home':{salary:28000,label:'UK Graduate Average'},'nhs-band-2-take-home':{salary:23615,label:'NHS Band 2 Entry'},'nhs-band-3-take-home':{salary:24625,label:'NHS Band 3 Entry'},'nhs-band-4-take-home':{salary:26530,label:'NHS Band 4 Entry'},'nhs-band-8a-take-home':{salary:53755,label:'NHS Band 8a Entry'},'nhs-band-8b-take-home':{salary:62215,label:'NHS Band 8b Entry'},'200-day-rate-take-home':{salary:44000,label:'£200/Day Contractor'},'250-day-rate-take-home':{salary:55000,label:'£250/Day Contractor'},'300-day-rate-take-home':{salary:66000,label:'£300/Day Contractor'},'350-day-rate-take-home':{salary:77000,label:'£350/Day Contractor'},'400-day-rate-take-home':{salary:88000,label:'£400/Day Contractor'},'450-day-rate-take-home':{salary:99000,label:'£450/Day Contractor'},'500-day-rate-take-home':{salary:110000,label:'£500/Day Contractor'},'550-day-rate-take-home':{salary:121000,label:'£550/Day Contractor'},'600-day-rate-take-home':{salary:132000,label:'£600/Day Contractor'},'650-day-rate-take-home':{salary:143000,label:'£650/Day Contractor'},'700-day-rate-take-home':{salary:154000,label:'£700/Day Contractor'},'750-day-rate-take-home':{salary:165000,label:'£750/Day Contractor'},'800-day-rate-take-home':{salary:176000,label:'£800/Day Contractor'},'1000-day-rate-take-home':{salary:220000,label:'£1,000/Day Contractor'}};
...
function Footer(){return(<footer style={{background:'#070D1C',padding:'40px 24px 28px',borderTop:'1px solid rgba(255,255,255,0.06)',marginTop:0}}><div style={{maxWidth:1100,margin:'0 auto'}}><div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(180px,1fr))',gap:'28px 24px',marginBottom:28}}><div><div style={{fontSize:10,color:'rgba(255,255,255,0.28)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:12,fontFamily:'JetBrains Mono',fontWeight:600}}>Tools</div>{[['/','Salary calculator'],['/ir35','IR35 calculator'],['/nhs','NHS pay bands'],['/hourly','Hourly rate'],['/bonus','Bonus tax calculator'],['/sacrifice','Salary sacrifice'],['/comparison','Job comparison'],['/maternity','Maternity pay'],['/tools','All tax tools']].map(([h,l])=>(<Link key={h} href={h} style={{display:'block',fontSize:12,color:'rgba(255,255,255,0.42)',marginBottom:7,lineHeight:1.4,textDecoration:'none'}}>{l}</Link>))}</div><div><div style={{fontSize:10,color:'rgba(255,255,255,0.28)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:12,fontFamily:'JetBrains Mono',fontWeight:600}}>Tax Planning</div>{[['/blog/60-percent-tax-trap','60% Tax Trap'],['/blog/hicbc-child-benefit-charge','Child Benefit Taper'],['/blog/personal-allowance-taper-100k','£100k PA Taper'],['/blog/plan-5-student-loan-take-home','Plan 5 Student Loan'],['/blog/salary-sacrifice-electric-car-uk-2026','EV Salary Sacrifice'],['/blog/pension-tax-relief-your-free-money','Pension Tax Relief'],['/blog/ir35-inside-outside-calculator-2026','IR35 Guide']].map(([h,l])=>(<Link key={h} href={h} style={{display:'block',fontSize:12,color:'rgba(255,255,255,0.42)',marginBottom:7,lineHeight:1.4,textDecoration:'none'}}>{l}</Link>))}</div><div><div style={{fontSize:10,color:'rgba(255,255,255,0.28)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:12,fontFamily:'JetBrains Mono',fontWeight:600}}>Public Sector</div>{[['/nhs-pay-guide','NHS Pay Guide'],['/teacher-pay-guide','Teacher Pay Guide'],['/public-sector-pay','Public Sector Hub'],['/public-sector-pay/police','Police Pay'],['/public-sector-pay/firefighters','Firefighter Pay'],['/public-sector-pay/civil-service','Civil Service Pay'],['/public-sector-pay/armed-forces','Armed Forces Pay'],['/public-sector-pay/council-workers','Council Workers Pay']].map(([h,l])=>(<Link key={h} href={h} style={{display:'block',fontSize:12,color:'rgba(255,255,255,0.42)',marginBottom:7,lineHeight:1.4,textDecoration:'none'}}>{l}</Link>))}</div><div><div style={{fontSize:10,color:'rgba(255,255,255,0.28)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:12,fontFamily:'JetBrains Mono',fontWeight:600}}>Salary Pages</div>{[['/30000-salary-take-home','£30,000 take-home pay'],['/40000-salary-take-home','£40,000 take-home pay'],['/50000-salary-take-home','£50,000 take-home pay'],['/60000-salary-take-home','£60,000 take-home pay'],['/80000-salary-take-home','£80,000 take-home pay'],['/100000-salary-take-home','£100,000 take-home pay'],['/salary-take-home-pay-uk','All UK salary guides']].map(([h,l])=>(<Link key={h} href={h} style={{display:'block',fontSize:12,color:'rgba(255,255,255,0.42)',marginBottom:7,lineHeight:1.4,textDecoration:'none'}}>{l}</Link>))}</div><div><div style={{fontSize:10,color:'rgba(255,255,255,0.28)',letterSpacing:'0.14em',textTransform:'uppercase',marginBottom:12,fontFamily:'JetBrains Mono',fontWeight:600}}>Contractor Pay</div>{[['/contractor-pay','Contractor pay hub'],['/ir35','IR35 calculator'],['/300-day-rate-take-home','£300/day take-home'],['/500-day-rate-take-home','£500/day take-home'],['/700-day-rate-take-home','£700/day take-home'],['/blog/ir35-inside-outside-calculator-2026','IR35 guide 2026'],['/tax-traps','Tax traps guide']].map(([h,l])=>(<Link key={h} href={h} style={{display:'block',fontSize:12,color:'rgba(255,255,255,0.42)',marginBottom:7,lineHeight:1.4,textDecoration:'none'}}>{l}</Link>))}</div></div><div style={{borderTop:'1px solid rgba(255,255,255,0.07)',paddingTop:20,display:'flex',justifyContent:'space-between',flexWrap:'wrap',gap:12,alignItems:'center'}}><Link href="/" style={{display:'flex',alignItems:'center',gap:9,textDecoration:'none'}}><div style={{width:28,height:28,background:'linear-gradient(135deg,#0D9488,#14B8A6)',borderRadius:7,display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}><span style={{color:'white',fontWeight:700,fontSize:12,fontFamily:'JetBrains Mono'}}>Tx</span></div><span style={{color:'white',fontFamily:'DM Serif Display',fontSize:16}}>Taxd<span style={{color:'#14B8A6'}}>Calc</span></span></Link><span style={{fontSize:11,color:'rgba(255,255,255,0.22)',fontFamily:'JetBrains Mono'}}>Updated April 2026 · 2026-27 HMRC rates</span><span style={{fontSize:11,color:'rgba(255,255,255,0.18)',maxWidth:320,lineHeight:1.6}}>For guidance only. Consult HMRC or a qualified tax adviser.</span></div></div></footer>);}
...
const DAY_RATE_VALUES=[200,250,300,350,400,450,500,550,600,650,700,750,800,1000];
const NHS_SLUGS=['nhs-band-2-take-home','nhs-band-3-take-home','nhs-band-4-take-home','nhs-band-5-take-home','nhs-band-6-take-home','nhs-band-7-take-home','nhs-band-8a-take-home','nhs-band-8b-take-home'];
const NHS_LABELS=['Band 2','Band 3','Band 4','Band 5','Band 6','Band 7','Band 8a','Band 8b'];
function RelatedLinks({slug,salaryNum}){
  const mob=useW()<640;
  const isDayRate=slug&&slug.endsWith('-day-rate-take-home');
  const isNHS=slug&&slug.includes('nhs-band');
  const links=[];
  if(isDayRate){
    links.push({href:'/ir35',label:'IR35 Calculator'},{href:'/contractor-pay',label:'Contractor Pay Hub'},{href:'/sacrifice',label:'Salary Sacrifice'},{href:'/blog/ir35-inside-outside-calculator-2026',label:'IR35 Guide'});
    const rateMatch=slug.match(/^(\d+)-day-rate/);
    if(rateMatch){const ri=DAY_RATE_VALUES.indexOf(+rateMatch[1]);if(ri>0)links.push({href:`/${DAY_RATE_VALUES[ri-1]}-day-rate-take-home`,label:`£${DAY_RATE_VALUES[ri-1]}/Day Take-Home`});if(ri>=0&&ri<DAY_RATE_VALUES.length-1)links.push({href:`/${DAY_RATE_VALUES[ri+1]}-day-rate-take-home`,label:`£${DAY_RATE_VALUES[ri+1]}/Day Take-Home`});}
  }else if(isNHS){
    links.push({href:'/nhs',label:'NHS Pay Calculator'},{href:'/nhs-pay-guide',label:'NHS Pay Guide'},{href:'/public-sector-pay',label:'Public Sector Hub'},{href:'/sacrifice',label:'Salary Sacrifice'});
    const ni=NHS_SLUGS.indexOf(slug);
    ...
    higher.forEach(v=>links.push({href:`/${v}-salary-take-home`,label:`£${v.toLocaleString('en-GB')} Salary`}));
  }
  return(<div style={{background:C.white,borderRadius:12,padding:mob?16:22,border:`1px solid ${C.border}`,boxShadow:C.shadow,marginBottom:14}}><h2 style={{fontFamily:'DM Serif Display',fontSize:mob?17:20,color:C.navy,marginBottom:4}}>Related Calculators &amp; Guides</h2><div style={{display:'flex',flexWrap:'wrap',gap:8,marginTop:10}}>{links.map(({href,label})=>(<Link key={href} href={href} style={{display:'inline-block',padding:'7px 12px',background:C.tealBg,border:`1px solid ${C.tealBd}`,borderRadius:7,fontSize:12,color:C.teal,fontWeight:600,textDecoration:'none'}}>{label}</Link>))}</div></div>);
}
  ...
  return(
    <>
      ...
      <div style={{maxWidth:1000,margin:'0 auto',padding:mob?'14px 16px 48px':'18px 24px 56px'}}>
        ...
        <RelatedLinks slug={slug} salaryNum={salaryNum}/>
      </div>
      <Footer/>
    </>
  );
