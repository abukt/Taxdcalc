...
export const metadata = {
  title: 'IR35 Calculator 2026-27 — Inside vs Outside | TaxdCalc',
  ...
  openGraph: {
    ...
    locale: 'en_GB',
    type: 'website',
    images: [{ url: '/api/og?title=IR35+Calculator+2026-27&subtitle=Inside+vs+Outside+Take-Home', width: 1200, height: 630, alt: 'IR35 Calculator 2026-27 — Inside vs Outside | TaxdCalc' }],
  },
  twitter: {
    ...
    images: ['/api/og?title=IR35+Calculator+2026-27&subtitle=Inside+vs+Outside+Take-Home'],
  },
  robots: {
    index: true,
    follow: true,
