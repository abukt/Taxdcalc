...
export default function MaternityPage() {
  ...
  const schemaFAQ={'@context':'https://schema.org','@type':'FAQPage',mainEntity:[
    ...
    {'@type':'Question',name:'How long does maternity pay last?',acceptedAnswer:{'@type':'Answer',text:'Statutory Maternity Pay (SMP) lasts up to 39 weeks. Maternity leave can last up to 52 weeks but only the first 39 weeks are paid if you qualify for SMP.'}},
    {'@type':'Question',name:'Is maternity pay taxable in the UK?',acceptedAnswer:{'@type':'Answer',text:'Yes. Statutory Maternity Pay (SMP) is taxable income. Income tax and National Insurance are deducted by your employer in the normal way.'}},
  ]};
