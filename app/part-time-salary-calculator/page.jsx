...
export default function PartTimePage(){
  ...
  const schema={
    ...
    '@graph':[
      {'@type':'WebApplication','@id':'https://taxdcal.co.uk/part-time-salary-calculator#calc',name:'Part-Time Salary Calculator UK 2026-27',applicationCategory:'FinanceApplication',offers:{'@type':'Offer',price:'0',priceCurrency:'GBP'},url:'https://taxdcal.co.uk/part-time-salary-calculator'},
      {'@type':'FAQPage',mainEntity:[
        {'@type':'Question',name:'How is pro-rata salary calculated?',acceptedAnswer:{'@type':'Answer',text:'Pro-rata salary = full-time salary × (actual hours or days / full-time hours or days). A £45,000 FTE salary at 4 days per week (out of 5) = £36,000 pro-rata gross.'}},
        {'@type':'Question',name:'Is take-home pay proportional to hours worked?',acceptedAnswer:{'@type':'Answer',text:'Not exactly. Because income tax and NI thresholds are fixed (not pro-rated), your effective tax rate is lower on a part-time salary. You keep a higher proportion of your pro-rata salary than your full-time equivalent does.'}},
      ]},
    ]
  };
